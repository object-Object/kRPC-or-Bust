...
if __name__ == '__main__':
    ...
    while True:
        ...
        (target, target_is_body) = ((conn.space_center.target_body, True) if conn.space_center.target_body
        ...
        (orbit, time_to_soi) = utils.get_next_orbit_in_soi(vessel.orbit, target) if target_is_body else (None, None)
